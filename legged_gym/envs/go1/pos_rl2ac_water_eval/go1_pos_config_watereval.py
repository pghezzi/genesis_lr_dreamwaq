...
class GO1PosRL2ACWaterCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        ...
        decimation = 20  # decimation: Number of control action updates @ sim DT per policy DT
...
class GO1PosRL2ACWaterCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
    runner_class_name = "OnPolicyRunnerPosRL2ACWater"
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        load_run = "Jan27_14-46-18_50hz_rl2ac_baseline_nogrf_02"
        checkpoint = 1500
        resume = True
