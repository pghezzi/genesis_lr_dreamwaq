...
class GO1TauFinetuneCfg( LeggedRobotCfg ):
    ...
    class domain_rand(LeggedRobotCfg.domain_rand):
        ...
        com_displacement_range_z = [0.10, 0.20]

        com_displacement_xy_min = 0.075
        com_displacement_xy_max = 0.2
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        class reward_curriculum():
            curr_reward_keys = ["feet_contact_forces",
                                "ang_vel_xy",
                                "base_height",
                                "lin_vel_z",
                                "orientation"]
            
            curr_reward_bounds = {"feet_contact_forces":[-1.0e-1,-5.0e-1],
                                  "ang_vel_xy":[-0.05, -0.1],
                                  "base_height":[-1.0,-2.0],
                                  "lin_vel_z":[-1.0,-2.0],
                                  "orientation":[-1.0,-2.0],
...
class GO1TauFinetuneCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
    runner_class_name = "OnPolicyRunnerTauFinetune" # Teacher-Student Runner
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        # debug_warmpinn_wb
        run_name = '100hz_tau_baseline_02_nogrf_finetune'
        experiment_name = 'rss_go1_pos'
        save_interval = 100
        
        
        load_run = "Jan17_16-14-58_100hz_tau_baseline_02_nogrf"
        checkpoint = 1500
        resume=True
