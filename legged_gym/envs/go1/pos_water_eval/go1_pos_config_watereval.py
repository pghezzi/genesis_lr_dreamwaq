...
class GO1PosWaterCfg( LeggedRobotCfg ):
...
class GO1PosWaterCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
    runner_class_name = "OnPolicyRunnerPosWater"
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        load_run = "Jan24_11-23-29_100hz_pos_baseline_02_no_grf_finetune"
        checkpoint = 3500
        resume = True
