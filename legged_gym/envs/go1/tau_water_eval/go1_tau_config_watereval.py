...
class GO1TauWaterCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        ...
        action_scale = [10.0, 10.0, 10.0] # action scale:  target torque = torque_scale * tau_action + defaultTorque
...
class GO1TauWaterCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
    runner_class_name = "OnPolicyRunnerTauWater"
    ...
    class policy( LeggedRobotCfgPPO.policy ):
        ...
        cenet_dec_out_dim = 45      # next obs (45) + grf_dim (12)
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        load_run = "Jan24_17-15-08_100hz_tau_baseline_02_nogrf_finetune"
        checkpoint = 3500
        resume = True
