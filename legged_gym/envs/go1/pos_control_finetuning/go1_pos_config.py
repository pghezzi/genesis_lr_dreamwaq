...
class GO1PosFinetuneCfg( LeggedRobotCfg ):
...
class GO1PosFinetuneCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
    runner_class_name = "OnPolicyRunnerPosFinetune" # Teacher-Student Runner
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        # debug_warmpinn_wb
        run_name = '100hz_pos_baseline_02_no_grf_finetune'
